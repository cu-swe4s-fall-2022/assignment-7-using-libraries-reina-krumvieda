...
class TestHw7(unittest.TestCase):
    ...
    def test_get_random_matrix(self):
        ...
        self.assertEqual(data_processor.get_random_matrix(self.rand_bad_val,
                                             self.rand_col_val), None)
        ...
        try:
            assert data_processor.get_random_matrix(self.rand_bad_val,
                                       self.rand_bad_val) != None,\
    ...
    def test_write_matrix_to_file(self):
        ...
        try:
            assert data_processor.write_matrix_to_file(
                self.rand_bad_val, self.rand_bad_val,self.test_file_name) != None,\
                    "ERROR3: Used Neg Inputs!"
            self.assertEqual(data_processor.write_matrix_to_file(
                self.rand_bad_val, self.rand_bad_val,self.test_file_name), None)
        except AssertionError as msg:
            print(msg)
